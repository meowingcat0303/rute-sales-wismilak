            ...
            if st.button("Generate Link"):
                if input_codes:
                    ...
                    if valid_kodes:
                        ...
                        st.success(f"Berhasil membuat rute untuk {len(valid_kodes)} toko!")
                        ...
                        c3, c4 = st.columns(2)
                        c3.download_button("📥 Download PDF (Hasil Copas)", generate_pdf(filtered_df), "Rute_Sales_Copas.pdf", "application/pdf")
